...
@foreach($data as $row)
      <tr>
                  ...
                  <td> 
                      <a  target="_blank"  href="<?php echo URL::to('donormember_epay/'.$row->admin_name.'/'.$row->tran_id) ?>">
                      <?php echo URL::to('donormember_epay/'.$row->admin_name.'/'.$row->tran_id) ?></a> 
                  </td>
