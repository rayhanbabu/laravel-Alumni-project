...
@section('donor_paymentview_select','active')
@section('content')
 
<div class="card mt-4 mb-3">
  <div class="card-header">
  <div class="row ">
               <div class="col-4"> <h5 class="mt-0"> Donor Payment View </h5></div>
                     <div class="col-4">
...
$(document).ready(function(){ 
  ...
  $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
    ...
    function fetch_data(page, sort_type="", sort_by="", search=""){
        $.ajax({
        url:"/admin/donor_payment/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search,
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form method="post" action="{{url('admin/donor_payment')}}"  class="myform"  enctype="multipart/form-data" >
          {!! csrf_field() !!}
...
<div class="modal fade" id="updatemodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{url('admin/donor_payment_update')}}"  class="myform"  enctype="multipart/form-data" >
            {!! csrf_field() !!}
