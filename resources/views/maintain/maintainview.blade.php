...
@section('page_title','Maintain View')
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Payemnt Issue View</b></label>
                   <select class="form-select" name="issue_view" id="edit_issue_view" aria-label="Default select example">
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Payemnt Issue Edit</b></label>
                   <select class="form-select" name="issue_edit" id="edit_issue_edit" aria-label="Default select example">
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                  </select>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Payemnt View</b></label>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Payemnt Edit</b></label>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Admin Info  View</b></label>
                   <select class="form-select" name="admin_view" id="edit_admin_view" aria-label="Default select example">
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                  </select>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Admin Info  Edit</b></label>
                   <select class="form-select" name="admin_edit" id="edit_admin_edit" aria-label="Default select example">
                      <option value="Yes">Yes</option>
                      <option value="No">No</option>
                  </select>
            </div>
      ...
      function fetchAll() {
        ...
        $.ajax({
          ...
          success: function(response){
               ...
               $("#edit_password").val(response.data.maintain_password);
               $("#avatar").html(
               ...
               $("#edit_admin_view").val(response.data.admin_view);
