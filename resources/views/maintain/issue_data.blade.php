@foreach($data as $row)
     ...
     <td>{{ $row->feedback}}</td>
     <td> <button type="button" data-feedback_status="{{$row->feedback_status}}" data-feedback_id="{{$row->id}}" 
         data-feedback="{{$row->feedback}}"  class="edit btn btn-info btn-sm">Edit </button> </td>
