            ...
            <div class="col-lg-6 align-self-center">
              ...
              @foreach($HeaderText as $item)
                <div class="item header-text">
                  <h2><em> {{$item->desig}} </em></h2>
                  <p>{{$item->text}}</p>
                    <div class="down-buttons">
                      <div class="main-blue-button-hover">
                        <a href="{{$item->link1}}">{{$item->name}}</a>
                     </div>
              ...
              @endforeach	 
			    ...
			    <div class="col-lg-6 align-self-center">
				  <div class="main-banner-image">
			          <img class="" src="{{asset('/uploads/admin/'.$HeaderImage->image) }}">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="{{asset('/uploads/admin/'.$Client->image) }}" alt="Image">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="section-heading">
            <h2> <span> {!! $Client->desig !!}</span></h2>
            <p>
               {!! $Client->text !!}
            </p>
